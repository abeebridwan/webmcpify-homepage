...
export default function Playground() {
  ...
  useEffect(() => {
    ...
    const register = async () => {
      ...
      await context.registerTool({
        name: "open_webmcpify_privacy", title: "Open privacy page", description: "Navigate to the WebMCPify privacy page. Discover the new page's tools after navigation.", inputSchema: { type: "object", properties: {}, additionalProperties: false }, annotations: { readOnlyHint: true, consequentialHint: false }, execute: () => { window.location.assign("/privacy"); return { ok: true, navigatingTo: "/privacy" }; },
      }, { signal: controller.signal });
      await context.registerTool({
